...
| Set my presence/status | ✅ | TopBar status dropdown (delegated write; world ring follows within a minute) |
| Meetings: see/join | ✅ portals / 🟡 join links wired, needs interactive verify |
| Create meeting ("open a portal") | ✅ | zone board form → real Teams meeting via /me/events |
...
| Capability | Status | Notes |
|---|---|---|
| Group directory as world geography | ✅ | all 184 unified groups synced as zones (disabled by default; admin allowlist) |
